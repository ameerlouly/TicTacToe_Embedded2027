...
{
    onButtonClicked(&NextPlayer , ui->grid0,0,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}

void SecDialog::on_grid1_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid1,1,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}

void SecDialog::on_grid2_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid2,2,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}


void SecDialog::on_grid3_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid3,3,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}


void SecDialog::on_grid4_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid4,4,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}


void SecDialog::on_grid5_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid5,5,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}


void SecDialog::on_grid6_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid6,6,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}


void SecDialog::on_grid7_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid7,7,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}


void SecDialog::on_grid8_clicked()
{
 onButtonClicked(&NextPlayer , ui->grid8,8,&MoveNum ,db,GridButtons, ui->Rematch, ui->GameReview,ui->WinnerText);
}
