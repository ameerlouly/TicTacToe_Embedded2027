...
void viewGameHistory(sqlite3* db, QTableWidget* table) {
    ...
    while (sqlite3_step(stmt) == SQLITE_ROW) {
        ...
        QObject::connect(whywhywhy[0], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[0]->text().mid(5,2).toInt()) -1]); });
    QObject::connect(whywhywhy[1], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[1]->text().mid(5,2).toInt()) -1]); });
        QObject::connect(whywhywhy[2], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[2]->text().mid(5,2).toInt()) -1]); });
    QObject::connect(whywhywhy[3], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[3]->text().mid(5,2).toInt()) -1]); });
        QObject::connect(whywhywhy[4], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[4]->text().mid(5,2).toInt()) -1]); });
    QObject::connect(whywhywhy[5], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[5]->text().mid(5,2).toInt()) -1]); });
        QObject::connect(whywhywhy[6], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[6]->text().mid(5,2).toInt()) -1]); });
    QObject::connect(whywhywhy[7], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[7]->text().mid(5,2).toInt()) -1]); });
        QObject::connect(whywhywhy[8], &QPushButton::clicked,[&]() {GameWindow->OldGameHistory(his[(whywhywhy[8]->text().mid(5,2).toInt()) -1]); });
