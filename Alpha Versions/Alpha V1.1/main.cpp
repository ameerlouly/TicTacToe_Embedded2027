...
void Setdiff2Hard();
void Setdiff2Normal();
void GuestMode(MainWindow *window,MainWindow1 *window1);
int mode = 0;
...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(LoginCheck, &QPushButton::clicked,[&]() {Check_data_forLogin(db,&window,&window1); });
    QObject::connect(GuestButton, &QPushButton::clicked,[&]() {GuestMode(&window,&window1);});
