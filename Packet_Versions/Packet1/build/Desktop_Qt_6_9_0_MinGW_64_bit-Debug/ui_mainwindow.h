...
public:
    ...
    QLabel *NameInProfile;
    QLabel *nohistoryforyou;
    QWidget *page_3;
    QLabel *last10;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        stackedWidget->setGeometry(QRect(10, -20, 751, 511));
        page_0 = new QWidget();
        ...
        LogOut_Button->setGeometry(QRect(40, 180, 83, 29));
        profile_button = new QPushButton(page_2);
        profile_button->setObjectName("profile_button");
        profile_button->setGeometry(QRect(40, 120, 83, 29));
        NameInProfile = new QLabel(page_2);
        NameInProfile->setObjectName("NameInProfile");
        NameInProfile->setGeometry(QRect(20, 160, 161, 20));
        nohistoryforyou = new QLabel(page_2);
        nohistoryforyou->setObjectName("nohistoryforyou");
        nohistoryforyou->setGeometry(QRect(282, 400, 201, 20));
        stackedWidget->addWidget(page_2);
        page_3 = new QWidget();
        page_3->setObjectName("page_3");
        last10 = new QLabel(page_3);
        last10->setObjectName("last10");
        last10->setGeometry(QRect(210, 30, 371, 91));
        QFont font7;
        font7.setPointSize(22);
        font7.setBold(true);
        font7.setItalic(true);
        last10->setFont(font7);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        NameInProfile->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
        nohistoryforyou->setText(QCoreApplication::translate("MainWindow", "Sign up to store your history", nullptr));
        last10->setText(QCoreApplication::translate("MainWindow", "LAST 10 GAME RESULTS", nullptr));
    } // retranslateUi
